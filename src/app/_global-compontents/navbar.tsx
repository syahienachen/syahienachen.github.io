...
export default function Navbar() {
    return (
        <Fragment>
            {/* MOBILE */}
            <nav id="navbar" className="flex sm:hidden justify-between items-center px-3 py-[2px] w-fullborder-b bg-white dark:bg-slate-950 h-14 shadow-lg shadow-slate-100 dark:shadow-slate-900">
